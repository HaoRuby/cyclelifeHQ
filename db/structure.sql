...
--
-- Host: localhost    Database: clproduction
-- ------------------------------------------------------
...
CREATE TABLE `listing_shapes` (
  ...
  `deeplink_enabled` tinyint(1) DEFAULT '0',
  `related_enabled` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `listings` (
  ...
  `availability` varchar(32) DEFAULT 'none',
  `deep_link` varchar(256) DEFAULT NULL,
  `selcat` varchar(50) DEFAULT NULL,
  `selsub` varchar(50) DEFAULT NULL,
  `selsha` varchar(50) DEFAULT NULL,
  `related_listing` varchar(255) DEFAULT NULL,
  `related_ids` int(5) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `locations` (
  ...
  KEY `index_locations_on_latitude_and_longitude` (`latitude`,`longitude`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `related_listings`
--

DROP TABLE IF EXISTS `related_listings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `related_listings` (
  ...
  `related_listing_ids` varchar(255) DEFAULT NULL,
  `heading` varchar(255) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `listing_id` int(5) DEFAULT NULL,
  `related_order` int(2) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `stripe_transactions` (
  ...
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `receipt` varchar(3096) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-01-19 20:26:25
...
INSERT INTO schema_migrations (version) VALUES ('20161011050453');

INSERT INTO schema_migrations (version) VALUES ('20161011050911');
...
INSERT INTO schema_migrations (version) VALUES ('20161029111310');

INSERT INTO schema_migrations (version) VALUES ('20161031040548');

INSERT INTO schema_migrations (version) VALUES ('20161101023021');
...
INSERT INTO schema_migrations (version) VALUES ('20161104031509');

INSERT INTO schema_migrations (version) VALUES ('20161106224534');

INSERT INTO schema_migrations (version) VALUES ('20161106225223');
...
INSERT INTO schema_migrations (version) VALUES ('20161108014238');

INSERT INTO schema_migrations (version) VALUES ('20161108034814');

INSERT INTO schema_migrations (version) VALUES ('20161108042258');

INSERT INTO schema_migrations (version) VALUES ('20161109094513');

INSERT INTO schema_migrations (version) VALUES ('20161118050355');

INSERT INTO schema_migrations (version) VALUES ('20161213233338');
