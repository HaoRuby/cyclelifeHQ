...
(function(module) {
  ...
  function update_related_form_view(locale, attribute_array, listing_form_menu_titles, ordered_attributes, selected_attributes) {
    // Hide everything
...
console.log("whathe");
    ...
    $('.related-selected-group').each(function() {
  ...
  function display_new_listing_form(selected_attributes, locale) {
    ...
    $.get(new_listing_path, selected_attributes, function(data) {
      $('.js-rel-form-fields').html(data);
      $('.js-rel-form-fields').removeClass('hidden');
    });
  }
  ...
  function display_option_group(group_type, selected_attributes, attribute_array) {
    $('.related-option-group[name=' + group_type + ']').children().each(function() {
  ...
  function select_listing_form_menu_link(link, locale, attribute_array, listing_form_menu_titles, ordered_attributes, selected_attributes) {
    ...
    var shouldLoadForm = update_related_form_view(locale, attribute_array, listing_form_menu_titles, ordered_attributes, selected_attributes);
  ...
  module.initialize_new_related_form_selectors = function(locale, attribute_array, listing_form_menu_titles) {
    ...
    window.addEventListener('popstate', function(evt) {
      ...
      $('.js-rel-form-fields').addClass('hidden');
    ...
    $('.newrel-listing-form').find('a.select').click(
      function() {
        $('.js-rel-form-fields').addClass('hidden');
        var shouldLoadForm = select_listing_form_menu_link($(this), locale, attribute_array, listing_form_menu_titles, ordered_attributes, selected_attributes);
  ...
  module.initialize_edit_related_form_selectors = function(locale, attribute_array, listing_form_menu_titles, category, subcategory, listing_shape, id) {
    var ordered_attributes = ["category", "subcategory", "listing_shape"];
    ...
    // Reset the view to initial state
    var shouldShowForm = update_relaterelatedd_form_view(locale, attribute_array, listing_form_menu_titles, ordered_attributes, selected_attributes);
