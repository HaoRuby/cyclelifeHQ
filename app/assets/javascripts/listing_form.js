...
(function(module) {
  ...
  function display_related_listing_form(selected_attributes, locale, id) {
    var listing_id = $('#listingid').val()
    var related_listing_path = '/' + locale + '/listings/related_form_content/'+listing_id;
    var request_params = _.assign({}, selected_attributes, {id: id});
    $.get(related_listing_path, request_params, function(data) {
      $('.js-form-fields').html(data);
      $('.js-form-fields').removeClass('hidden');
    });
  }
  ...
  module.initialize_related_listing_form_selectors = function(locale, attribute_array, listing_form_menu_titles) {
    ...
    if(shouldLoadForm) {
      display_related_listing_form(selected_attributes, locale);
    }
